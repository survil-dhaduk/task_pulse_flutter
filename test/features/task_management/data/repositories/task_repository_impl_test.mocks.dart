...
// in task_pulse/test/features/task_management/data/repositories/task_repository_impl_test.dart.
...
import 'package:task_pulse/core/services/hive_service.dart' as _i3;
...
class MockHiveService extends _i1.Mock implements _i3.HiveService {
  ...
  @override
  _i4.Future<void> deleteBox(String? boxName) => (super.noSuchMethod(
        Invocation.method(
          #deleteBox,
          [boxName],
        ),
  ...
  @override
  bool isBoxOpen(String? boxName) => (super.noSuchMethod(
        Invocation.method(
          #isBoxOpen,
          [boxName],
        ),
